  ...
  <fs-page>
    <fs-crud ref="crudRef" v-bind="crudBinding">
      <template #actionbar-right>
        <n-button @click="showData">获取表格数据，打印data</n-button>
        <n-button @click="disabledEdit">退出编辑模式</n-button>
        <n-button @click="enabledFreeEdit">自由编辑模式</n-button>
        <n-button @click="enabledRowEdit">行编辑模式</n-button>
      </template>
    </fs-crud>
  </fs-page>
</template>

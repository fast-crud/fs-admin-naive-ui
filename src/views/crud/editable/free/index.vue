  ...
  <fs-page>
    ...
    <fs-crud ref="crudRef" v-bind="crudBinding">
      <template #actionbar-right>
        ...
        <!--            <n-radio-group class="ml-1" v-model="crudBinding.table.editable.mode">-->
        <!--              <n-radio-button label="free">自由模式</n-radio-button>-->
        <!--              <n-radio-button label="row">行编辑模式</n-radio-button>-->
        <!--            </n-radio-group>-->
